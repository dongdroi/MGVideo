...
public class MGVideoPlayer extends FrameLayout {
    ...
    public static final int RESIZE_MODE_NORMAL = 0;
    public static final int RESIZE_MODE_FULLSCREEN = 1;
    private int mResizeMode = RESIZE_MODE_NORMAL;
