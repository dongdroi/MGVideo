...
public class MGControllerView extends FrameLayout implements IMediaController {
    ...
    public void setOrientationListener(OrientationListener listener) {
        if (listener != null) {
            ...
            mOrientation = listener.getRequestedOrientation();
        } 
    }
    ...
    public void show(int timeout) {
        if (DEBUG) {
            Log.d(TAG, "MGControllerView show mShowing = " + mShowing);
        }
        if (!mShowing) {
            setProgress();
            updatePausePlay();
    ...
    public void hide() {
        if (DEBUG) {
            Log.d(TAG, "MGControllerView hide mShowing = " + mShowing);
        }
        if (mShowing) {
            try {
    ...
    private View.OnClickListener mFullScreenListener = new View.OnClickListener() {
        public void onClick(View v) {
            Log.v(TAG, "into the mFullScreenListener " + mOrientation);
            if (mOrientationListener != null) {
                mOrientation = (mOrientation + 1) % 2;
                mOrientationListener.setRequestedOrientation(mOrientation);
            }
        }
    };
