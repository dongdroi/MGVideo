...
const ScrollableTabBar = React.createClass({
  ...
  propTypes: {
    ...
    moreIcon: React.PropTypes.number,
    onClickMoreBtn: React.PropTypes.func,
  },
  ...
  render() {
    ...
    >
      ...
      <View style 	= {{justifyContent: 'center', position: 'absolute', top: 0, 
            right: 0, bottom: 0, paddingRight:8, backgroundColor: 'white'}}>
        <TouchableOpacity onPress={this.props.onClickMoreBtn}>
        <Image style={{width: 24, height: 24}} source 	= {this.props.moreIcon}>
        </Image>
        </TouchableOpacity>
      </View>
    </View>);
